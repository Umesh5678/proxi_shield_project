            ...
            <div className="row">
                <div className="col-12 p-5 bg-light">
                 ...
                 <ul>
                    ...
                    <li className=" d-inline-block ml-3">Flooring & Coatings</li>
                 </ul>
                </div>
            </div>
            </div>
            <div className="container">
            <h1 className="c1">Flooring & Coatings</h1>
                <div className="row">
                
                    <div className="col-md-4 mt-5">
                         <img src="https://mykarment.com/wp-content/uploads/2015/09/Industrial-Flooring.png" width="100%"/>
                    </div>
